...
public final class SingleImagePicker {
        ...
        if (mTempFiles.size() > 0) {
            for (String path : mTempFiles) {
                ...
                if (temp.exists()) {
                    ...
                    Logger.d(TAG, "删除拍照保存的图片----" + path + "------" + delete);
                }
            }
        }
    }
    ...
    public void onPermissionsGranted(int requestCode, List<String> perms) {
        Logger.d(TAG, "onPermissionsGranted: " + requestCode);
    ...
    public void onPermissionsDenied(int requestCode, List<String> perms) {
        Logger.d(TAG, "onPermissionsDenied: " + requestCode);
